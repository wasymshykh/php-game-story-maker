...
INSERT INTO `answer_blocks` VALUES (6,54,'choose this answer bro',NULL,'A',NULL,1,NULL),(7,54,'choose another answer bro',NULL,'A',NULL,2,NULL),(8,55,'hello world, nice question',NULL,'A',NULL,7,NULL),(9,55,'why do you choose item1?',1,'A',NULL,8,NULL),(10,55,'why do you choose item2?',2,'A',NULL,9,NULL),(11,56,'game going to end1',NULL,'A',NULL,67,NULL),(12,56,'game going to end2',NULL,'A',NULL,68,NULL),(13,56,'game going to end3',NULL,'A',NULL,69,NULL),(14,56,'game going to end4',NULL,'A',NULL,70,NULL),(15,56,'game going to end5',NULL,'A',NULL,71,NULL);
...
CREATE TABLE `game_results` (
  ...
  `result_game_id` int(11) DEFAULT NULL,
  `result_game_ending` varchar(100) DEFAULT NULL,
  `result_name` varchar(100) DEFAULT NULL,
  `result_created` datetime NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`result_id`),
  KEY `game_results_FK` (`result_game_id`),
  CONSTRAINT `game_results_FK` FOREIGN KEY (`result_game_id`) REFERENCES `games` (`game_id`)
...
INSERT INTO `game_results` VALUES (3,6,'end1','test','2020-12-29 02:38:25');
...
CREATE TABLE `games` (
  ...
  `game_end1` int(11) DEFAULT 0,
  `game_end2` int(11) DEFAULT 0,
  `game_end3` int(11) DEFAULT 0,
  `game_end4` int(11) DEFAULT 0,
  `game_end5` int(11) DEFAULT 0,
  PRIMARY KEY (`game_id`),
...
INSERT INTO `games` VALUES (6,23,'Title for cool Storys','marcos','https://randomwordgenerator.com/img/picture-generator/57e0d5474257a914f1dc8460962e33791c3ad6e04e5074417d2e7ed69e45cc_640.jpg','https://www.random.org/audio-noise/?channels=2&amp;volume=100&amp;rate=16000&amp;size=8&amp;date=2020-12-16&amp;format=wav&amp;deliver=browser','1','2020-12-17 02:15:05',1,0,0,0,0),(7,23,'Title for another cool Story','Jack','https://randomwordgenerator.com/img/picture-generator/52e4d1424f5aa914f1dc8460962e33791c3ad6e04e5074417d2e72d2954ac5_640.jpg','https://www.random.org/audio-noise/?channels=2&amp;volume=100&amp;rate=16000&amp;size=8&amp;date=2020-12-16&amp;format=wav&amp;deliver=browser','1','2020-12-17 02:16:04',0,0,0,0,0);
...
INSERT INTO `rounds` VALUES (54,6,0),(55,6,1),(56,6,2);
...
INSERT INTO `text_blocks` VALUES (13,54,'hello dear world lol hello dear world lol hello dear world lolhello dear world lolhello dear world lolhello dear world lolhello dear world lolhello dear world lolhello dear world lolhello dear world lolhello dear world lol',NULL,'A',NULL,NULL),(15,55,'This is the round 1, ok? This is the round 1, ok? This is the round 1, ok? This is the round 1, ok? This is the round 1, ok? This is the round 1, ok? This is the round 1, ok? This is the round 1, ok? ',NULL,'A',NULL,NULL),(16,55,'This is for item 1 previous, ok? This is for item 1 previous, ok? ',1,'A',NULL,NULL),(17,55,'This is for item 2 previous, ok? This is for item 2 previous, ok? ',2,'A',NULL,NULL),(18,56,'You choosed item1 and r1a1',1,'A',7,NULL),(19,56,'You choosed item2 and r1a2',2,'A',8,NULL),(20,56,'you are good to go',NULL,'A',NULL,NULL);
...
-- Dump completed on 2020-12-29  3:05:12
